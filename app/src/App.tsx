            ...
            <div className="grid grid-cols-1 gap-4 relative">
              ...
              <div className="relative aspect-[3/4] rounded-2xl overflow-hidden shadow-lift-lg group">
                <img 
                  ...
                  alt="I. E. Jones III - Author and Founder of Jones Narrative Labs" 
              ...
              <div className="relative aspect-[3/4] rounded-2xl overflow-hidden shadow-lift-lg group">
                <img 
                  ...
                  alt="I. E. Jones III, Los Angeles based author, full-stack developer, and AI engineer" 
                  className="w-full h-full object-cover transition-transform duration-700 ease-out-expo group-hover:scale-105"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-6 p-4 rounded-lg bg-secondary">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-coral">{selectedBook.year}</div>
...
function UpdatesSection() {
  ...
  const articles = [
    ...
    {
      id: 8,
      title: 'The New Idol: From Totems to AI — Part II',
      category: 'Philosophy',
      image: '/images/blog-8.jpg',
      url: '/assets/article-8.html',
      date: 'Apr 4, 2025',
      excerpt: 'DEI and the Return of the Daemon or "Spiritual Guide" - Exploring the emergence of daemonic intelligence in the digital age.',
    },
    {
      id: 9,
      title: 'The New Idol: From Totems to AI — Part III',
      category: 'Philosophy',
      image: '/images/blog-9.jpg',
      url: '/assets/article-9.html',
      date: 'Apr 11, 2025',
      excerpt: 'Übermensch, Imago Dei, and the Age of Spiritual Machines - The future human at the crossroads of evolution and revelation.',
    },
    {
      id: 1,
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      <main>
        ...
        <h1 className="sr-only">Jones Narrative Labs | Stories Architected by I.E. Jones III</h1>
        <HeroSection />
        <AboutSection />
        <BooksSection />
        <VideoSection />
